...
const HomePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Home | IGNUX - Professional Fireworks & Stage FX</title>
        <meta name="description" content="Professional fireworks and stage FX services for weddings, corporate events, and festivals across Kenya. Igniting unforgettable experiences." />
      </Helmet>
      ...
      <section className="section testimonials-section bg-surface">
        <div className="container">
          ...
          >
            ...
            <p className="section-subtitle text-secondary text-center max-w-2xl mx-auto mb-12">
              Don't just take our word for it - hear from those who've experienced the IGNUX magic
            </p>
